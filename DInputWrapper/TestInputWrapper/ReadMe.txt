========================================================================
    コンソール アプリケーション: TestInputWrapper プロジェクトの概要
========================================================================

この TestInputWrapper アプリケーションは、AppWizard により作成されました。

このファイルには、TestInputWrapper 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


TestInputWrapper.vcxproj
...
TestInputWrapper.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、TestInputWrapper.pch 
